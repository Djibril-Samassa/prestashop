...
class Stripe_official extends PaymentModule
{
    ...
    public static $paymentMethods = [
        ...
        'klarna' => [
            'name' => 'Klarna',
            'flow' => 'redirect',
            'countries' => ['AT', 'BE', 'DE', 'DK', 'ES', 'FI', 'GB', 'IE', 'IT', 'NL', 'NO', 'SE', 'US', 'FR', 'EE', 'GR', 'LV', 'LT', 'SK', 'SI', 'UK'],
            'countries_names' => [
                'en' => 'Austria, Belgium, Germany, Italy, Netherlands, Spain',
                'fr' => 'Autriche, Belgique, Allemagne, Italie, Pays-Bas, Espagne',
                'de' => 'Österreich, Belgien, Deutschland, Italien, Niederlande, Spanien',
            ...
            'currencies' => ['eur', 'dkk', 'gbp', 'nok', 'sek', 'usd', 'aud', 'nzd', 'cad', 'pln', 'chf'],
            'enable' => self::ENABLE_KLARNA,
            'catch_enable' => false,
            'display_in_back_office' => false,
            'require_activation' => 'No',
            'new_payment' => 'No',
        ...
        'afterpay_clearpay' => [
            'name' => 'Afterpay',
            'flow' => 'redirect',
            'countries' => ['AU', 'GB', 'NZ', 'US', 'CA', 'FR', 'ES', 'UK', 'US'],
            'countries_names' => [
                'en' => 'Austria, Belgium, Germany, Italy, Netherlands, Spain',
                'fr' => 'Autriche, Belgique, Allemagne, Italie, Pays-Bas, Espagne',
                'de' => 'Österreich, Belgien, Deutschland, Italien, Niederlande, Spanien',
    ...
    public function __construct()
    {
        ...
        $this->button_label['card'] = $this->l('Pay with Stripe');
    ...
    {
//        try {
        PrestaShopLogger::addLog('intra', 3);
        if (!parent::install()) {
            PrestaShopLogger::addLog('parent install error', 3);
        ...
        PrestaShopLogger::addLog('passes', 3);
        ...
        PrestaShopLogger::addLog('passes first part', 3);
        $shopGroupId = Stripe_official::getShopGroupIdContext();
        $shopId = Stripe_official::getShopIdContext();
        ...
        PrestaShopLogger::addLog('pass second part', 3);
...
//            PrestaShopLogger::addLog('ex 1', 3);
//            Stripe_officialClasslib\Extensions\ProcessLogger\ProcessLoggerHandler::logError(
...
//            PrestaShopLogger::addLog('ex 2', 3);
//            Stripe_officialClasslib\Extensions\ProcessLogger\ProcessLoggerHandler::logError(
//                $e->getMessage() . ' - ' . $e->getTraceAsString(),
//                null,
//                null,
...
//        }
    ...
    public function hookHeader()
    {
        ...
        Media::addJsDef([
            ...
            'stripe_create_checkout_url' => $this->context->link->getModuleLink(
                $this->name,
                'createCheckout',
                [],
                true
            ...
            'stripe_order_failure_return_url' => $this->context->link->getModuleLink(
                $this->name,
                'orderFailure',
                [],
                true
            ...
            'capture_method' => (Configuration::get(Stripe_official::CATCHANDAUTHORIZE) == 'on') ? 'manual' : 'automatic',
